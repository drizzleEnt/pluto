...
import (
	...
	"github.com/drizzleent/pluto/app"
)
...
// genesisCommand builds genesis-related `plutod genesis` command. Users may provide application specific commands as a parameter
